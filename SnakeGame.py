...
intro = pygame.image.load("introimage.jpg")
...
#Music
pygame.mixer.music.load('bg1_music.mp3')
...
def welcome():
    ...
    while not exit_game:
        ...
        text_screen("Snake by Drashti", yellow, 300, 80,)
        text_screen("Press Space Bar To Play", white, 450, 550)
...
def gameloop():
    ...
    while not exit_game:
        if game_over:
            ...
            text_screen("Score: " + str(score), blue, 330, 280)
            ...
            text_screen("Your Score: " + str(score) +"     HighScore: " + str(highscore), black, 5, 5)
